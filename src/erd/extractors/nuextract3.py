...
``erd.phases.phase1`` with the same interface: image_bytes + system_prompt
→ ContextSheet dict.
...
used_by: erd.phases.phase1  (when extractor="nuextract3")
"""
...
from erd.phases.phase1 import ContextSheet
